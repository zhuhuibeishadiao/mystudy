...
{
	return ((PTEB)NtCurrentTeb())->ProcessEnvironmentBlock;
}
...
{
	return HandleToUlong(((PTEB)NtCurrentTeb())->ClientId.UniqueProcess);
}
...
{
	return HandleToUlong(((PTEB)NtCurrentTeb())->ClientId.UniqueThread);
}
