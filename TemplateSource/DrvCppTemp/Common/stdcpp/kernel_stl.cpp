...
_Use_decl_annotations_ EXTERN_C int __cdecl __stdio_common_vsprintf(
	unsigned __int64 _Options, char *_Buffer, size_t _BufferCount,
	char const *_Format, _locale_t _Locale, va_list _ArgList)
{
	return __stdio_common_vsprintf_s(_Options,
		_Buffer, _BufferCount,
		_Format, _Locale,
		_ArgList);
}

_Use_decl_annotations_ EXTERN_C int __cdecl __stdio_common_vswprintf(
	unsigned __int64 _Options, wchar_t *_Buffer, size_t _BufferCount,
	wchar_t const *_Format, _locale_t _Locale, va_list _ArgList)
{
	return __stdio_common_vswprintf_s(_Options,
		_Buffer, _BufferCount,
		_Format, _Locale,
		_ArgList);
}
